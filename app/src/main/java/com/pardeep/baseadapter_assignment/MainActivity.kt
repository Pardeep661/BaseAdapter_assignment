package com.pardeep.baseadapter_assignment
...
import com.pardeep.baseadapter_assignment.databinding.ActivityMainBinding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding?.floatButton?.setOnClickListener{
            Dialog(this).apply {
                ...
                val name = findViewById<EditText>(R.id.cd_name)
                val rollNumber = findViewById<EditText>(R.id.cd_rollNumber)
                val Subject = findViewById<EditText>(R.id.cd_Subject)
